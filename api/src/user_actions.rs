...
use dioxus::prelude::{server_fn::error::{NoCustomError, WrapError}, *};
use sea_orm::{prelude::Decimal, ActiveModelTrait, ActiveValue};
use serde::{Deserialize, Serialize};

use crate::{auth::{is_logged_in, ServerLoginToken}, db::db_conn, entities::{ingredient_name, recipe, recipe_ingredient}, CustomServerError};
...
#[server]
pub async fn create_recipe(login_token: ServerLoginToken, name: String, description: String, instructions: String, ingredients: Vec<NewIngredient>) -> Result<i32, ServerFnError> {
    ...
    for ingredient in ingredients {
        ...
        let recipe_ingredient = recipe_ingredient::ActiveModel {
            ...
            amount: ActiveValue::Set(Decimal::from_f32_retain(ingredient.amount.unwrap_or(1.0)).expect("Invalid amount")),
